<?php defined('IN_IA') or exit('Access Denied');?> <div class="form-group">
                <label class="col-sm-2 control-label">会员中心显示股东中心入口</label>
	   ...
	   <div class="form-group">
                <label class="col-sm-2 control-label">分销中心显示股东中心入口</label>
                <div class="col-sm-9 col-xs-12">
                	<?php if(cv('globonus.set.edit')) { ?>
 ...
 <div class="form-group">
     <label class="col-sm-2 control-label">股东须知</label>
     <div class="col-sm-9 col-xs-12">
         <?php if(cv('globonus.set.edit')) { ?>
