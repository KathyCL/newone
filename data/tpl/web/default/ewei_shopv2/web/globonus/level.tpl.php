                ...
                <tbody>
					...
					<?php  } ?>
                        ...
                        <td>
                            ...
                            <a class='btn btn-default btn-sm' data-toggle='ajaxModal'  href="<?php  echo webUrl('globonus/level/edit', array('id' => $row['id']))?>" title="<?php if(cv('globonus.level.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>"><i class='fa fa-edit'></i> <?php if(cv('globonus.level.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a>
                            <?php  } ?> 
                            <?php  if($row['id']!='default') { ?>
							 <?php if(cv('globonus.level.delete')) { ?>
								<a class='btn btn-default btn-sm' data-toggle='ajaxRemove'  href="<?php  echo webUrl('globonus/level/delete', array('id' => $row['id']))?>" data-confirm="确认删除此等级吗？"><i class='fa fa-remove'></i> 删除</a></td>
						<?php  } ?>
						<?php  } ?>
