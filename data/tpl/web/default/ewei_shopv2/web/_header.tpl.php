...
<div class="navbar-collapse collapse" id="navbar">
    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            ...
            <ul role="menu" class="dropdown-menu">
                ...
                <li><a href="<?php  echo url('cloud/renren');?>"><i class="icon icon-down"></i> 系统更新</a></li>
                <?php  } ?>
    ...
    <ul class="nav navbar-nav    gray-bg">
        ...
        <li <?php  if($_W['current_menu']=='auth') { ?> class="active"<?php  } ?>><a href="<?php  echo url('cloud/renren');?>">更新</a></li>
    </ul>
