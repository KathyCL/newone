...
<head>
	...
	<?php  if($_GET["m"] != "qwx_shangmen" || ($_GET["m"] == "qwx_shangmen" && $_GET["do"] != "cart" && $_GET["do"] != "goods")) { ?><script type="text/javascript" src="<?php  echo $_W['siteroot'];?>app/resource/js/lib/mui.min.js"></script><?php  } ?>
