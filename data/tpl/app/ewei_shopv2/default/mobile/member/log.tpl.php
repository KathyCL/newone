...
<div class='fui-page  fui-page-current member-log-page'>
    ...
    <script id="tpl_member_log_list" type="text/html">
        ...
        <%each list as log%>
        <div class="fui-list goods-item" <%if log.type==1%>style="height:2.75rem"<%/if%>>
            ...
            <div class='fui-list-angle'>
                <div style="font-size: .75rem;color: #000;">+<%log.money%> 元</div>
                <%if log.status==0%>
                ...
                <%/if%>
                <%if log.status==-1%>
                <span  class=' text-danger'><%if log.type==1%>充值失败<%/if%></span>
                <%/if%>
                <%if log.status==3%>
        ...
        <%if log.type==1%>
        <div class="fui-list" style="height: 1.85rem;">
            <div class="fui-list-inner">
