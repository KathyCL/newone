    ...
    <div class="fui-cell">
        ...
        <div class="fui-cell-info">
            ...
            <ul class="fui-images fui-images-sm" id="images">
                ...
                <li style="background-image:url(<?php  echo tomedia($v)?>)" class="image image-sm" data-filename="<?php  echo $v;?>"><span class="image-remove"><i class="icon icon-close"></i></span></li>
                <?php  } } ?>
